...
<head>
    ...
    <style>
        ...
        /* FIX UKURAN & EFEK PREMIUM CARD MOVIE */
        .card-movie { 
        ...
        .card-movie:hover { 
            ...
            box-shadow: 0 14px 28px rgba(229, 9, 20, 0.4), 0 10px 10px rgba(229, 9, 20, 0.25); 
        }
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <?php else: ?>
                        <span class="text-secondary small me-1"><i class="fa-solid fa-user-lock me-1"></i>Guest Mode</span>
            ...
            <div class="col-md-8 bg-dark p-4 rounded shadow border border-secondary">
                ...
                <form method="POST" action="">
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-4">
                            <button type="submit" id="btnFind" class="btn btn-danger-netflix w-100 py-2.5 shadow">
                                <i class="fa-solid fa-magnifying-glass me-2"></i>Find Matches <i class="fa-solid fa-sparkles ms-1 text-warning small"></i>
                            </button>
                        </div>
                    </div>
                </form>
            ...
            <div class="row align-items-center mb-4 g-3">
                <div class="col-12 col-md-4 text-start">
                    <h3 class="fw-bold text-white m-0">
                        <i class="fa-solid fa-film text-danger me-2"></i>Explore Movies
                    </h3>
                </div>
                <div class="col-12 col-md-4 mx-auto text-center">
                    <div class="input-group shadow-sm">
                        ...
                        <input type="text" id="searchMovie" class="form-control bg-dark text-white border-secondary small" placeholder="Cari film di katalog...">
                    </div>
                </div>
                <div class="col-12 col-md-4 d-none d-md-block"></div>
            </div>
            
            <div class="row row-cols-1 row-cols-md-4 g-4" id="catalogRow">
                    ...
                    <div class="col movie-item">
                        <div class="card card-movie shadow-sm position-relative">
                            ...
                            <div class="card-body p-3 d-flex flex-column">
                                ...
                                <h6 class="text-white fw-bold m-0 text-truncate movie-title" style="font-size: 1.05rem;">
                                    <?= $movie['judul']; ?>
                                </h6>
                                <div class="d-flex justify-content-between align-items-center mt-3 pt-2 border-top border-secondary">
            ...
            <div class="row mb-4">
                ...
                <div class="col-6 col-md-3">
                    ...
                    <ul class="list-unstyled d-flex flex-column gap-2 small">
                        ...
                        <li><a href="#searchMovie">Smart Search</a></li>
                ...
                <div class="col-md-2">
                    ...
                    <div class="d-flex gap-3 fs-5">
                        <a href="https://wa.me/628xxxxxxx" target="_blank"><i class="fa-brands fa-whatsapp text-success"></i></a>
    ...
    <script>
        // 1. SCRIPT AUTOMATIC SMOOTH SCROLL KE AREA HASIL REKOMENDASI
        <?php if (!empty($_SESSION['rekomendasi'])): ?>
        window.addEventListener('DOMContentLoaded', (event) => {
            const sectionRekomendasi = document.getElementById('rekomendasi-section');
            if (sectionRekomendasi) {
                sectionRekomendasi.scrollIntoView({ behavior: 'smooth' });
            }
        });
        <?php endif; ?>

        // 2. SCRIPT LIVE FILTER SEARCH BAR (Mencari Judul di Explore Movies secara Real-Time)
        document.getElementById('searchMovie').addEventListener('keyup', function() {
            ...
            items.forEach(function(item) {
                let judulFilm = item.querySelector('.movie-title').textContent.toLowerCase();
                if (judulFilm.includes(keyword)) {
                    item.style.display = ''; 
                } else {
