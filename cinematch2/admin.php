                ...
                <div class="admin-card p-4 shadow-lg">
                    ...
                    <form method="POST" action="admin.php">
                        ...
                        <div class="row g-2 mb-3">
                            <div class="col-md-4">
                                <label class="text-secondary small fw-bold mb-1">Tahun Rilis</label>
                                <input type="number" name="tahun" class="form-control bg-dark text-white border-secondary" placeholder="Contoh: 2026" required>
                            </div>
                            <div class="col-md-4">
                                <label class="text-secondary small fw-bold mb-1">Rating IMDB</label>
                                <input type="text" name="rating" class="form-control bg-dark text-white border-secondary" placeholder="Contoh: 8.5" required>
                            </div>
                            <div class="col-md-4">
                                <label class="text-secondary small fw-bold mb-1">Rating Usia</label>
