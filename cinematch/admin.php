...
<body>
    ...
    <tr>
        <td><img src="<?= $film['poster']; ?>" class="poster-preview" alt="Thumb"></td>
        <td class="fw-bold text-white text-truncate" style="max-width: 180px;"><?= $film['judul']; ?></td>
        <td><span class="badge bg-secondary px-2 py-1 small"><?= $film['genre']; ?></span></td>
        <td><?= $film['tahun']; ?></td>
        <td class="text-warning fw-bold"><i class="fa-solid fa-star me-1 small"></i><?= $film['rating']; ?></td>
        
        <td>
    <a href="edit_film.php?judul=<?= urlencode($film['judul']); ?>" class="btn btn-sm btn-outline-warning me-2">
